 ...
 * This file demonstrates how to integrate Tiderift with a web frontend
 */

// For React/Vue/Angular applications
export class TideriftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new TideriftClient(provider, contractAddress);
